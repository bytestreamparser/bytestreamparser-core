...
import static org.bytestreamparser.api.testing.extension.RandomParametersExtension.Randomize.ASCII_ALPHANUMERIC;
...
class CharStringParserTest {
  ...
  void parse_single_byte_charset(
      String charset, @Randomize(regexp = ASCII_ALPHANUMERIC) String value) throws IOException {
  ...
  void parse_multi_byte_charset(String charset, @Randomize String value) throws IOException {
    CharStringParser<TestData> parser = createParser(charset);
    ByteArrayInputStream input = new ByteArrayInputStream(value.getBytes(charset));
    String parsed = parser.parse(input);
  ...
  void parse_single_byte_charset_insufficient_data(
      String charset, @Randomize(length = 2, regexp = ASCII_ALPHANUMERIC) String value)
      throws IOException {
    CharStringParser<TestData> parser = createParser(charset);
    ByteArrayInputStream input = new ByteArrayInputStream(value.getBytes(charset));
  ...
  @ParameterizedTest
  @ValueSource(strings = {"US-ASCII", "IBM1047", "ISO-8859-1"})
  void pack_single_byte_charset(
      String charset, @Randomize(length = 3, regexp = ASCII_ALPHANUMERIC) String value)
      throws IOException {
    CharStringParser<TestData> parser = createParser(charset);
  ...
  @ParameterizedTest
  @ValueSource(strings = {"UTF-8", "UTF-16"})
  void pack_multi_byte_charset(String charset, @Randomize(length = 3) String value)
      throws IOException {
    CharStringParser<TestData> parser = createParser(charset);
    ByteArrayOutputStream output = new ByteArrayOutputStream();
    parser.pack(value, output);
  ...
  @ParameterizedTest
  @ValueSource(strings = {"US-ASCII", "IBM1047", "ISO-8859-1"})
  void pack_single_byte_insufficient_data(
      String charset, @Randomize(length = 2, regexp = ASCII_ALPHANUMERIC) String value) {
    CharStringParser<TestData> parser = createParser(charset);
    ByteArrayOutputStream output = new ByteArrayOutputStream();
  ...
  @ParameterizedTest
  @ValueSource(strings = {"UTF-8", "UTF-16"})
  void pack_multi_byte_insufficient_data(String charset, @Randomize(length = 2) String value) {
    CharStringParser<TestData> parser = createParser(charset);
    ByteArrayOutputStream output = new ByteArrayOutputStream();
    assertThatThrownBy(() -> parser.pack(value, output))
        .isInstanceOf(IllegalArgumentException.class)
